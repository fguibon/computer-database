...
<body>
	...
	<footer class="navbar-fixed-bottom">
		<div class="container text-center">
			...
			<div class="dropdown pull-left btn-group btn-group-sm">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item btn" href="?lang=en"><spring:message
							code="app.lang.english" /></a> <a class="dropdown-item btn"
